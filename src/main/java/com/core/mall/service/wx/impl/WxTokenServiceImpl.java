...
import com.core.mall.model.wx.AccessTokenResponse;
...
public class WxTokenServiceImpl extends AbstractWxService implements WxTokenService {
    ...
    public String getWxToken() {
        ...
        try {
            response = httpService.get(this.fmtReqWebsUrl(WxWebUrlEnum.GET_WX_TOKEN, paramMap), AccessTokenResponse.class);
        } catch (Exception e) {
